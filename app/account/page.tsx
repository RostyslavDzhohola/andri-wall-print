...
import { BuyerAccountDashboard } from "@/components/buyer/account-dashboard";
...
function accountRuntimeAvailable() {
      ...
      <section className="mx-auto grid min-h-[calc(100vh-3rem)] max-w-3xl place-items-center">
        <Card className="w-full shadow-[0_24px_70px_rgba(35,31,25,0.12)]">
          <CardHeader>
            ...
            <CardDescription className="font-semibold uppercase">Account unavailable</CardDescription>
            <h1 className="text-3xl font-semibold leading-tight md:text-5xl">Saved previews are unavailable.</h1>
          </CardHeader>
          <CardContent className="grid gap-5">
            <p className="text-base leading-7 text-muted-foreground">
              Ask Wall Print Pro to refresh the account setup before saving previews.
            </p>
...
export default async function AccountPage() {
  if (!accountRuntimeAvailable()) {
    return <AccountSetupMissing />;
  }
