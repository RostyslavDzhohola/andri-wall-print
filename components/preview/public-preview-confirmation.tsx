...
import { BuyerPreviewSaveAction } from "@/components/preview/buyer-preview-save-action";
      ...
      <CardContent className="grid gap-4 p-4" suppressHydrationWarning>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {buyerAccountsEnabled ? (
            <BuyerPreviewSaveAction confirmationId={confirmation?.id} publicSlug={publicSlug} />
          ) : (
